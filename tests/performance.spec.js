...
test.describe('Performance Testing', () => {
  ...
  test('should test page performance across different networks', async ({ page, context }) => {
    ...
    const networkConditions = [
      { name: 'Fast 3G', downloadThroughput: 1.6 * 1024, uploadThroughput: 0.75 * 1024, latency: 150 },
      { name: 'Slow 3G', downloadThroughput: 0.5 * 1024, uploadThroughput: 0.5 * 1024, latency: 300 },
    ];
