...
test.describe('Responsive Design Testing', () => {
  ...
  test('should adapt navigation for mobile devices', async ({ page }) => {
    ...
    const mobileToggle = page.locator(
      '.mobile-toggle, .nav-toggle, .hamburger, [aria-label*="menu"], .menu-button'
    ).first();
  ...
  test('should validate Neo-Brutalist elements remain distinctive across devices', async ({ page }) => {
